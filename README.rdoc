...
== Couchrest support
Couchrest adapter has been added to support Couchrest::ExtendedDocument models

 - Support indexing Couchrest views and view queries
 - Support indexing couchrest document in batch (default: 200)

Sounds all good, Show me some examples please
